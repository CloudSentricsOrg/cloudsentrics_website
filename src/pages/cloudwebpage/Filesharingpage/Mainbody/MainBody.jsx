          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 lg:gap-10 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                backIcon: "🎓",
                backTitle: "School Management",
                backDesc: "Complete school operations platform with automated fee reminders and secure result delivery.",
              },
              {
                frontIcon: "🏥",
                frontTitle: "Healthcare Management",
                frontDesc: "Patient records, lab management, prescriptions, appointments, pharmacy, and staff training.",
                backIcon: "🏥",
                backTitle: "Healthcare Management",
                backDesc: "Full clinical operations with appointment reminders and secure result delivery to patients.",
              },
              {
                frontIcon: "🔌",
